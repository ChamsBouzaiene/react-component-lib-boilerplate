...
import { borderRadius, buttonStyle, color, ColorProps, variant, space, fontSize, SpaceProps, FontSizeProps } from 'styled-system'
...
export const ThemedButton = styled('button')<Props>({
    ...
    border: 0,
    outline: 0
}, borderRadius, buttonSize, buttonStyle, color, space, fontSize)